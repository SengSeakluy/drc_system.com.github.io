        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                            class="form-edit-add"
                            action="{{ $edit ? route('voyager.'.$dataType->slug.'.update',($read ?? false)? $dataTypeContent->getKey().'&'.$read : $dataTypeContent->getKey()) : route('voyager.'.$dataType->slug.'.store') }}"
                                    ...
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ $display_options->width ?? 12 }} {{ $errors->has($row->field) ? 'has-error' : '' }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        {{ $row->slugify }}
                                            ...
                                            <label class="control-label" for="name">
                                                ...
                                                @elseif ((isset($dataRelationShip->validation->rule) == "required"))
                                                    <span class="text-danger">*</span>
                                                @endif
                                            </label>
                                            ...
                                            @elseif ($row->type == 'relationship')
                                                @if(isset($parent_name) && explode('/',$parent_name)[0]=='Merchant')
                                                    
                                                    @include('voyager::formfields.relationship', ['options' => $row->details,'parent_key'=>explode('/',$parent_name)[1] ])
                                                @else
