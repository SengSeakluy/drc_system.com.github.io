...
@section('css')
    <style>
        ...
        .d-card-title{
            font-size: 18px;margin: auto;margin-left: 0;text-align: left;
        }
    ...
    <div class="page-content">
       {{-- @include('voyager::alerts') --}}
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    @widget('ChartsWidgets\DailyRunBack', ['title' => "Total Contacts"]) 
                </div>
                <div class="col-md-6">
                    @widget('ChartsWidgets\DailyLogin', ['title' => "Total Contacts"]) 
                </div>
            </div>
        ...
        $(document).ready(function() {
            $('#submit').on('click',function(){
                ...
                $.ajax({
                    url: '{{ route("filter")}}',
                    method: 'post',
                    data: { _token:_token,date_from:from, date_to:to },
                    dataType: "json",
                    success: function (data) {
                        ...
                        if(data['code']==400){
                            ...
                            $('#date_from').css('border-width',3+'px '+ 3+'px');                           
                        }
                        if(data['code']==401){
                            $('#date_to').css('borderColor','red');
                            $('#date_to').css('border-width',3+'px '+ 3+'px');                           
                        }
                    }
                });
            });
