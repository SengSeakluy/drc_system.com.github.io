    ...
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if($edit){{ route('voyager.posts.update', $dataTypeContent->id) }}@else{{ route('voyager.posts.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <!-- ### DETAILS ### -->
                    <div class="panel panel panel-bordered panel-warning card-panel">
                        <div class="panel-heading">
                        ...
                        <div class="panel-body" style="padding:30px 20px 20px;">
                    ...
                    <!-- ### IMAGE ### -->
                    <div class="panel panel-bordered panel-primary card-panel">
                        <div class="panel-heading">
                    ...
                    <!-- ### SEO CONTENT ### -->
                    <div class="panel panel-bordered panel-info card-panel">
                        <div class="panel-heading">
